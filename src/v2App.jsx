...
const ALL_LLMS = [
  ...
  { id: 'copilot', name: 'Microsoft Copilot', url: 'https://copilot.microsoft.com/', icon: 'https://www.bing.com/sa/simg/favicon-trans-bg-blue-mg.ico', category: 'Major' },
  { id: 'perplexity', name: 'Perplexity', url: 'https://www.perplexity.ai/', icon: 'https://www.perplexity.ai/favicon.svg', category: 'Search' },
  { id: 'you', name: 'You.com', url: 'https://you.com/', icon: 'https://you.com/favicon.ico', category: 'Search' },
  { id: 'huggingchat', name: 'HuggingChat', url: 'https://huggingface.co/chat/', icon: 'https://huggingface.co/favicon.ico', category: 'Open Source' },
  { id: 'poe', name: 'Poe', url: 'https://poe.com/', icon: 'https://poe.com/favicon.ico', category: 'Aggregator' },
  { id: 'mistral', name: 'Mistral AI', url: 'https://chat.mistral.ai/', icon: 'https://chat.mistral.ai/favicon.ico', category: 'Open Source' },
  { id: 'deepseek', name: 'DeepSeek', url: 'https://chat.deepseek.com/', icon: 'https://chat.deepseek.com/favicon.ico', category: 'Specialized' },
];
